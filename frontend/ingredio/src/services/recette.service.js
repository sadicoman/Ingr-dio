...
export const recetteService = {
	...
	mettreAJourRecette: (id, data) => axios.put(`${API_URL}/recettes/${id}`, data, config),
	...
	getLatestRecipes: limit => axios.get(`${API_URL}/recettes?limit=${limit}`, config),
};
...
export const ingredientsRecetteService = {
	...
	supprimerIngredient: id => axios.delete(`${API_URL}/ingredientsRecettes/${id}`, config),
