...
import "../../btn/btn.scss";
import IconSupprimer from "../GardeManger/IconeSupprimer";
				...
				<div className="form">
					...
					<div className="ic2">
						<div className="input-container--fichier">
							...
							/>
							<label
								className={`label__fichier ${files.length > 0 ? "noVisible" : ""}`}
								htmlFor="upload-file"
							>
							...
							<span
								className={`label__fichier--end ${files.length > 0 ? "visible" : ""}`}
							>
								<div className="label__container">
									<IconesImagesUpload />
									<span className="files-counter">{files.length} file(s)</span>
								</div>
							</span>
						</div>
					</div>
						...
						<>
							<li className="aliments__el" key={aliment.AlimentID}>
								<img
									...
									alt={aliment.Nom}
								/>
								<h4 className="title title--niveau5 aliment__nom">{aliment.Nom}</h4>
								{aliment.UserID === userInfo?.id && (
									<div className="aliment__btn">
										...
										<button
											...
											onClick={() => handleSuppressionAliment(aliment.AlimentID)}
										>
