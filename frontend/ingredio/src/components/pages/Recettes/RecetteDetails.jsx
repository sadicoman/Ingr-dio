					...
					{recette.UserID === userInfo?.id && (
						<>
							<div className="containner__second">
								<button className="btn btn--modifier" onClick={handleModifierRecette}>
									<span className="button__text">Modifier</span>
									<span className="button__icon">
										<IconModifier />
									</span>
								</button>
								<button className="btn btn--supprimer" onClick={handleSupprimerRecette}>
				...
				<ul className="primary__list">
					...
					<li className="primary__el ">
						<p>
							...
							<span className="primary__difficulte">{recette.NiveauDeDifficulte}</span>
						</p>
					</li>
					<li className="primary__el">
			...
			<section className="section">
				...
				<div className="form">
					<div className="input-container ic2">
						<div className="containner__quantite containner__quantite--actif">
							<button className="btn--moin" type="button" onClick={diminuerQuantite}>
								-
							</button>
							<input
								...
								type="number"
								value={nombreDePersonnes}
								onChange={e => handleChangeNombreDePersonnes(Number(e.target.value))}
								min="1"
							/>
							<button className="btn--plus" type="button" onClick={augmenterQuantite}>
								+
							</button>
							<div className="cut cut--nombreDePersonne" ref={addToCutRefs}></div>
							<label className="iLabel ilabel--quantite" ref={addToLabelRefs}>
								Nombre De Personnes
							</label>
						</div>
					</div>
				...
				<ul className="ingredient__list">
					{ingredients.map(ingredient => (
						<li className="ingredient__el" key={ingredient.IngredientRecetteID}>
							<img
					...
					<div className="form__recetteDetails">
						...
						>
							<div className="form__fermer">
								<button className="fermer__btn" onClick={() => setShowForm(false)}>
									X
								</button>
							</div>
							<div className="ingredients__container ingredients__container--first">
								...
								<div className="input-container ic2">
									<select className="input" {...register("NiveauDeDifficulte")}>
							...
							{ingredientsFields.map((field, index) => (
								<div className="ingredients__container" key={field.id}>
									...
									<div className="input-container ic2 input-container--bottom">
										<select className="input" {...register(`ingredients.${index}.Unite`)}>
									...
									<div className="etapes__container" key={field.id}>
										...
										<div className="input-container ic2">
											<textarea
												...
												// }`}
											/>
											<div className="cut cut--actif cut--etape" ref={addToCutRefs}></div>
											<label className="iLabel iLabel--actif" ref={addToLabelRefs}>
