...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 03 fév. 2024 à 22:02
...
INSERT INTO `aliments` (`AlimentID`, `Nom`, `UserID`, `createdAt`, `updatedAt`, `ImageUrl`) VALUES
(1, 'pomme jonagold', 2, '2023-11-09 11:36:37', '2023-11-09 11:50:04', NULL),
(2, 'banane', 2, '2023-11-09 11:36:50', '2023-11-09 11:36:50', NULL),
(3, 'carotte', 2, '2023-11-09 11:36:58', '2023-11-09 11:36:58', NULL),
(4, 'tomate', 2, '2023-11-09 11:37:06', '2023-11-09 11:37:06', NULL),
(5, 'concombre', 2, '2023-11-09 11:37:15', '2023-11-09 11:37:15', NULL),
(6, 'salade', 2, '2023-11-09 11:37:41', '2023-11-09 11:37:41', NULL),
(7, 'fraise', 2, '2023-11-09 11:37:49', '2023-11-09 11:37:49', NULL),
(8, 'cerise', 2, '2023-11-09 11:37:56', '2023-11-09 11:37:56', NULL),
(9, 'melon', 2, '2023-11-09 11:38:03', '2023-11-09 11:38:03', NULL),
(10, 'poire', 2, '2023-11-09 14:25:35', '2023-11-09 14:25:35', NULL),
(11, 'pastèque', 2, '2023-11-09 14:21:40', '2023-11-09 14:21:40', NULL),
(12, 'farine', 2, '2023-11-16 15:07:29', '2023-11-16 15:07:29', NULL),
(15, 'maïs', 2, '2023-11-17 18:35:45', '2023-11-17 18:35:45', NULL),
(17, 'cornichon', 2, '2023-11-24 15:24:52', '2023-11-24 19:15:19', NULL),
(18, 'sucre', 2, '2023-11-24 19:15:37', '2023-11-24 19:15:37', NULL),
(19, 'riz (sushi)', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(20, 'steak', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(21, 'saumon cru', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(22, 'edamame', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(23, 'maïs (grains)', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(24, 'cubes de jambon', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(25, 'feta', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(26, 'betterave', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(27, 'echalote', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(28, 'oignon jeune', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(29, 'carotte râpée', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(30, 'oignon frit', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(31, 'oeufs de poisson', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(32, 'sauce teriyaki', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(33, 'sauce soja', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(34, 'huile', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL),
(35, 'eau', 2, '2023-11-27 15:24:26', '2023-11-27 15:24:26', NULL);
...
ALTER TABLE `aliments`
  ...
  ADD CONSTRAINT `aliments_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `etapes`
  ...
  ADD CONSTRAINT `etapes_ibfk_2` FOREIGN KEY (`RecetteID`) REFERENCES `recettes` (`RecetteID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `gardemangers`
  ...
  ADD CONSTRAINT `gardemangers_ibfk_3` FOREIGN KEY (`UserID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `gardemangers_ibfk_4` FOREIGN KEY (`AlimentID`) REFERENCES `aliments` (`AlimentID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `ingredientsrecettes`
  ...
  ADD CONSTRAINT `ingredientsrecettes_ibfk_3` FOREIGN KEY (`AlimentID`) REFERENCES `aliments` (`AlimentID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ingredientsrecettes_ibfk_4` FOREIGN KEY (`RecetteID`) REFERENCES `recettes` (`RecetteID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `recettes`
--
ALTER TABLE `recettes`
  ADD CONSTRAINT `recettes_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`RoleID`) REFERENCES `roles` (`RoleID`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
